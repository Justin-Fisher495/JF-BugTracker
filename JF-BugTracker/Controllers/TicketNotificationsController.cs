...
namespace JF_BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,IsRead,NotificationBody,RecipientId,CreatedDate")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,IsRead,NotificationBody,RecipientId,CreatedDate")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
