...
namespace JF_BugTracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase avatar)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    AvatarPath = "/Avatars/defult_user.png"
                };
                if (avatar != null)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    EmailHelper.SendEmail(new Helpers.EmailService()
                    {
                        ...
                        Body = $"Thank you for registering. <br/><a href='{callbackUrl}'>Click Here</a> to confirm your account.",
        ...
        public async Task<ActionResult> ResendEmailConfirmation(ForgotPasswordViewModel model)
        {
            ...
            {
                string code = await UserManager.GenerateEmailConfirmationTokenAsync(user.Id);
                var callbackUrl = Url.Action("ConfirmEmail", "Acount", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Title = "Jägerwanzen Notification",
                    Body = $"Your account password has been recovered. <br/><a href='{callbackUrl}'>Click Here</a> to change your password.",
                    Reciepents = new List<string>() { user.Email }
                });
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    Title = "Jägerwanzen Notification",
                    Body = $"Your account password has been reset. <br/><a href='{callbackUrl}'>Click Here</a> to change your password.",
                    Reciepents = new List<string>() { user.Email }
                });
