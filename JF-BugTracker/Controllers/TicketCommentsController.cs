...
namespace JF_BugTracker.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Body,OwnerId")] TicketComment ticketComment, int ticketId)
        {
            if (ModelState.IsValid)
            {
                ticketComment.CreatedDate = DateTime.Now;
                ticketComment.TicketId = ticketId;
                ticketComment.OwnerId = User.Identity.GetUserId();
