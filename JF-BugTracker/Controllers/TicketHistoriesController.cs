...
namespace JF_BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UpdaterId,Property,OldValue,NewValue,UpdatedDate")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UpdaterId,Property,OldValue,NewValue,UpdatedDate")] TicketHistory ticketHistory)
        {
            if (ModelState.IsValid)
            {
